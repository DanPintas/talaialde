...
public class LoginViewImpl extends VaadinAbstractView<LoginPresenter>
  ...
  private Component buildFields() {
    ...
    final Button signin = new Button(getMessage(Messages.LOGIN_DO_LOGIN),
        FontAwesome.SIGN_IN);
  ...
  private void doLogin(String username, String password) {
    if (StringUtils.isEmpty(username)) {
      NotificationUtils.showWarning(getMessage(Messages.LOGIN_ERROR_TITLE),
