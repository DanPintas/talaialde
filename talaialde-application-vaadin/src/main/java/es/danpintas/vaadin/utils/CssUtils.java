...
public class CssUtils {
    ...
    /**
     * Permite añadir estilos personalizados de CSS a un componente. <br>
     * No se pueden sobreescribir estilos fijados por métodos Vaadin; 
     * normalmente, esto se aplicará a dimensiones. <br>
     * Las llamadas posteriores a este método eliminan las reglas añadidas 
     * previamente; es responsabilidad del usuario mantenerlas y añadirlas 
