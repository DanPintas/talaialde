...
import es.dasaur.talaialde.admin.users.JpaAuthRepository;
import es.dasaur.talaialde.admin.users.JpaRelRoleAuth;
import es.dasaur.talaialde.admin.users.JpaRelRoleAuthRepository;
import es.dasaur.talaialde.admin.users.JpaRole;
import es.dasaur.talaialde.admin.users.JpaRoleRepository;
